...
4. Hooks are Claude-schema (`PreToolUse`/`Stop`, `Bash|Execute` matchers): Ralph works on Claude Code + Droid, NOT Cursor (different hook events) - never assume the guard fires there.
