...
| Prose contract for agent-emitted artifacts (the rules PR bodies, tracker comments, spec prose, and changelog entries are drafted under; cited at each emission point) | [`plugins/flow-next/docs/prose.md`](plugins/flow-next/docs/prose.md) |
