...
| User-POV drive map (`/flow-next:features` - seed or maintain `.flow/features/` for QA and drive) | [`plugins/flow-next/skills/flow-next-features/SKILL.md`](plugins/flow-next/skills/flow-next-features/SKILL.md) |
