...
- [ ] The spec and task specs describe what, not how: signatures, repo patterns carried with `file:line` refs, and non-obvious gotchas only. A copy-paste-ready function body in a task spec has broken this.
