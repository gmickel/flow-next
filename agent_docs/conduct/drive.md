...
- [ ] Rungs above `agent-browser` are probed (`command -v`, MCP list, `uname -s`) before being planned around, and an absent driver degrades to the next rung or a documented limitation rather than ending the pass.
