...
**Tracker-sync re-measurement (2026-07-29): medium, 17,829 LF-normalized
characters (~4,457 chars/4 tokens).** The always-loaded set is exactly
`SKILL.md` (6,656) + `steps.md` (6,924) +
