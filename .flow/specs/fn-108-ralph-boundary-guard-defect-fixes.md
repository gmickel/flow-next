...
2. **Droid mismatch**: accept tool_name in ("Bash","Execute") in ralph-guard.py:952 (and the Droid edit-tool names at :947), or drop `|Execute` from hooks.json and document Ralph as Claude-Code-only. Pick one; today the two files contradict.
