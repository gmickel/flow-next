...
5. Deep-pass confidence-promotion and verdict-recompute math: see fn-113 for the judgment question; this spec only relocates/dedupes, fn-113 decides what survives.
...
- No new backends in this spec. No receipt-schema changes. RALPH_ITERATION stamping dedupe belongs to fn-114 (coordinate; whoever lands first extracts the helper).
