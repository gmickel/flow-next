...
6. **Gemini excluded for now** (maintainer 2026-07-19): do not seed Gemini rows into any ladder or role despite copilot offering them; revisit only on explicit request.
