...
stage: impl-review - ran (host backend, fresh fable-5 reviewers; r1 NEEDS_WORK -> fixes a67390ce -> r2 SHIP)stage: plan-sync - ran (drift: yes; .3 gained uninstall.md staleness + grok-4.5 slug + dangling test ref fix, .5 gained mirror content-pin gap item; cross-spec deferred to conductor)
