...
## Done summary
Retroactive tidy (2026-08-04): 2.0.0 shipped 2026-06 (bump, crossEpic alias removal, mirror regen, CHANGELOG) — the release this task describes happened; record never closed. Surfaced by brief orphan rule; no new work.
## Evidence
- Commits:
- Tests:
- PRs: