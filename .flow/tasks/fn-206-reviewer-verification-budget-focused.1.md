...
- [ ] Four rendered fixtures rebaselined via the test's measured-rebaseline workflow (immutable pre-edit commit, fn-206 rationale); plan/standalone fixtures byte-identical; masked hashes + bounded token deltas green (R2)
