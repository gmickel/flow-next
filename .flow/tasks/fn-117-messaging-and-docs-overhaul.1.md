...
3. Boundary gates: add the private-vocabulary/client-name grep pair to the spec's Quick commands as an executable check; run it against current state to confirm baseline-clean.
