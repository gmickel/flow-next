...
8. **Promote errors.** `--idea 99` (out of range) → exit 2. `--idea 0` → exit 2. Corrupt artifact target → exit 3 (matches `flowctl prospect read` on corrupt; task 4 shipped at flowctl.py:7489-7511).
