...
- `agent_docs/setup-modes.md` (~line 26 invariants): per-(path,id) keying note, following the numbered bolded-lead-sentence pattern.
...
- [ ] setup-modes.md invariant note added (R7)
