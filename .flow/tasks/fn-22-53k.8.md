...
## Done summary
<!-- Updated by plan-sync: fn-22-53k.7 documented epic-review command and completion_review status handling in ralph.md (lines 309, 338, 943-954), flowctl.md (lines 103-108, 352-360, 587-588, 631), and README.md. Reference implementation at ralph.sh lines 943-954 shows status handler pattern before final else clause. Env var is COMPLETION_REVIEW (no separate REQUIRE_ per epic spec). -->
