# fn-92-opinionated-prime-mode-project-type.10 Docs finalization: 13 in-repo docs + CHANGELOG Unreleased + fn-85 cross-edit
...
- CHANGELOG under Unreleased, no version bump (batched releases).
...
- [ ] CHANGELOG Unreleased entry; no bump
