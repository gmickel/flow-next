...
4. Stage the docs-site changelog entry (scannable highlights, not a repo-CHANGELOG copy) - under the Unreleased/staged convention, no version bump.
5. Tone: skeptical-staff-engineer register per the messaging architecture; lead with the proof-backed claim (probe-validated zero-setup), no hype.
