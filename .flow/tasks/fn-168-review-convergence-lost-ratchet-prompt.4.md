...
## Acceptance
- [ ] R4: scripted two-round codex-style transcript reaches round 3 without ESCALATE via the production reservation path; a genuinely stalling transcript still ESCALATEs
