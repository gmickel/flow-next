...
**Size:** M
**Files:** `plugins/flow-next/skills/flow-next-work/phases.md`, `plugins/flow-next/skills/flow-next-work/SKILL.md`, `plugins/flow-next/skills/flow-next-work/references/setup-questions.md`
**Touches:** [plugins/flow-next/skills/flow-next-work/phases.md, plugins/flow-next/skills/flow-next-work/SKILL.md, plugins/flow-next/skills/flow-next-work/references/setup-questions.md]
...
- R5: delete the export line at `SKILL.md:109` and remove `export` from the tip at `references/setup-questions.md:21`. The roster must agree with the review-mode enum work already hands to workers at `phases.md:237`, which never contained `export` — that enum is the truth the advertised roster was drifting from.
...
- Do NOT edit `flow-next-impl-review/` prose: its export string is pinned by `tests/test_skill_prose_diet.py:307-312` and no requirement here needs it changed.
...
- [ ] `--review=export` no longer appears as an accepted work review mode in `SKILL.md` or `references/setup-questions.md` (R5)
...
- [ ] `flow-next-impl-review/` prose untouched; `cd plugins/flow-next/tests && python3 -m unittest test_skill_prose_diet test_backend_spec -q` green
