# fn-92-opinionated-prime-mode-project-type.9 Eval green: fixtures + real-repo expectations pass, smoke re-baseline (R19/R13)
...
## Acceptance
- [ ] All fixture + reference expectation rows pass (R19); wrapper un-skipped, 3-OS portable
