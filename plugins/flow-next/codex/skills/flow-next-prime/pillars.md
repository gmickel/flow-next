...
The single published DC2 coverage scale is **X/8** (the 8-row agents-md-scout rubric; pass ~5/8). Every file that cites the DC2 bar normalizes to this scale - there is no /10 variant.
...
|-------|----------|-------------|
| Pillars 1-5 | Agent Readiness (level basis) | ✅ Fixes offered via plain-text numbered prompt |
