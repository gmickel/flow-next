...
| DC2 | CLAUDE.md/AGENTS.md quality | Agent instruction file present AND clears agents-md-scout's coverage bar (score ≥ ~5/8: has real commands + structure, not a stub). A thin stub = ⚠️ → offer *augment*, not a no-op create. |
