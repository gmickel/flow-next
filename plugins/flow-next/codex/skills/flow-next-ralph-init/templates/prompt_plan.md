...
4) The skill returns one terminal verdict: `<verdict>SHIP|NEEDS_WORK|MAJOR_RETHINK|NEEDS_HUMAN</verdict>`.
 ...
 - Only returns to Ralph after SHIP, MAJOR_RETHINK, or NEEDS_HUMAN
