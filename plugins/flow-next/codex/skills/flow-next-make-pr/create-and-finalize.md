...
The "Impact" section is the only host-agent-prose section. Two-to-four sentences, plain language, anchored to the modules and R-IDs above. It follows the artifact prose contract in [docs/prose.md](../../docs/flow-next/prose.md); proceed without it when the doc is absent. **Never speculate about future work** ("this opens the door to..."). State what happened and why a future debugger would care.
