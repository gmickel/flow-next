...
| Phase 1.5b | Structured cognitive aid — refresh final head/merge base after the optional HTML commit, then validate/select/render the grounded v1 object before body composition. |
