...
| Existing structured brief with resolved business and technical choices | `$flow-next-capture` the brief | Structured brief or chart briefing ready | Skip chart. Narrow or skip refine only after the read-back proves no material gaps | signal absent |
