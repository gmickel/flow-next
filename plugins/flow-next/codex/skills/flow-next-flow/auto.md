...
4. **No gh touch here.** Except for existing-PR selection above, PR state belongs to the all-done classification branch; a gh call in SELECT has broken this.
