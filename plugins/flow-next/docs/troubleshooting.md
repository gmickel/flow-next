...
- The default is 8. You can tune `MAX_REVIEW_ITERATIONS` for a genuinely large ticket, but the cap remains enabled and escalation remains preferable to a larger budget.
