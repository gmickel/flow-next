...
The default pipeline composes ([root README](../../../README.md#compose-the-pipeline)). This page owns the **stage axis**: which stages a given piece of work runs, shown as five worked examples from a full epic down to a docs chore.
