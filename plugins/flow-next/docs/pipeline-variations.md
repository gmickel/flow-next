...
The default pipeline composes ([root README](../../../README.md#compose-the-pipeline)). This page owns the **stage axis**: which stages a given piece of work runs, shown as six worked examples from a full epic down to a docs chore.
...
**Signal:** a spec already exists and is fully known - acceptance criteria are clear, the work fits one implementation context, and decomposing it into tasks would convert no unknown. The [GLOSSARY entry](../../../GLOSSARY.md#no-plan-route) names this the **No-plan route**.
