...
- [`../../../STRATEGY.md`](../../../STRATEGY.md) - flow-next's strategic intent and active tracks.
- [`../../../GLOSSARY.md`](../../../GLOSSARY.md) - canonical vocabulary (Spec, Task, R-ID, ...).
- [`../../../CONTRIBUTING.md`](../../../CONTRIBUTING.md) - contributor entry point.
- [`../../../agent_docs/releasing.md`](../../../agent_docs/releasing.md) - the release walk, including which documentation surface each step updates.
