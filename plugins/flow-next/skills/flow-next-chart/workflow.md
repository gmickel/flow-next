...
6. Empty - ask what to chart or which chart to work (blocking question).
...
Use `AskUserQuestion` (or numbered plain-text fallback) for approve / edit / abort. Edit cycles revise the proposal and re-read-back. Abort creates nothing.
