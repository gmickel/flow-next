...
- **Claude-native, no mirror regen here.** This file uses Claude-native tool names
  (`AskUserQuestion`, `Task`). The Codex mirror is regenerated by `sync-codex.sh` in
  a **separate** task (fn-68.5) — do NOT regenerate it here.
