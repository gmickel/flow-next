...
### 7b — `question <spec-id | issue-handle>` — post a question-valve comment
...
### 7c — `list-relations <issue-handle>` — read one issue's dependency relations
