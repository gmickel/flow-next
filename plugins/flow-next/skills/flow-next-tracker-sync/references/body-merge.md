...
Show the human the **merged body** (every cleanly-merged section already folded)
with the single contradicting section flagged inline, and ask via `AskUserQuestion`
