...
RECEIPT_PATH="${REVIEW_RECEIPT_PATH:-/tmp/completion-review-receipt-${SPEC_ID}.json}"  # spec-scoped default (concurrent specs no longer collide); explicit REVIEW_RECEIPT_PATH still wins
