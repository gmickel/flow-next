...
`chain broken; parent #<n> closed unmerged`, `retarget of #<n> ... conflicts in <files>`, and `merge-async still pending` are described in [`docs/troubleshooting.md`](../../../docs/troubleshooting.md).
