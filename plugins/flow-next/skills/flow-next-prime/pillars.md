...
|----|-----------|----------------|
| SV1 | Linter configured | ESLint, Biome, Flake8, Ruff, golangci-lint, or Clippy config exists |
| SV2 | Formatter configured | Prettier, Black, gofmt, or rustfmt config/usage detected |
