...
### Agent Readiness (fast-scout-tier scanners; claude-md-scout + docs-gap-scout on the thinking scout tier)
- `tooling-scout` — linters, formatters, pre-commit, type checking
- `claude-md-scout` — CLAUDE.md/AGENTS.md analysis (thinking scout tier — judgment-heavy)
