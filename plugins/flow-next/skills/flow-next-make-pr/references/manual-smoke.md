...
- Tasks not all done + interactive → warn on stderr + proceed (open items force a draft via create-and-finalize); Ralph exits 2; `--dry-run` warns and continues. No `AskUserQuestion` for open tasks.
