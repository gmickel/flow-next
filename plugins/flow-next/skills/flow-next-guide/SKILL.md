...
Unknown model identity needs no detector or blocking question: judge the spec and execution context available. A direct-route recommendation names Flow-Next work; it never means bypassing its implementation review, coverage, completion policy, or opt-in QA.
