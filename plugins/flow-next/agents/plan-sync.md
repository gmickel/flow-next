...
[^crossspec-legacy]: `planSync.crossSpec` is the canonical config key. The pre-1.1.3 name `planSync.crossEpic` remains readable as a legacy alias (one-line stderr deprecation; removed in 2.0).
