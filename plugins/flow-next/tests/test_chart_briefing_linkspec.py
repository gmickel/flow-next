# Split from test_chart_briefing.py 2026-08-07 to halve the slowest unit-suite shard (runner shards per file). Link-spec, cluster, and failpoint briefing tests.
