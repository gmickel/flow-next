...
The committed user-POV directory (`.flow/features/`) recording how a user reaches and drives each user-facing feature, consumed by QA/drive for navigation; distinct from the code-POV `/flow-next:map` index.
