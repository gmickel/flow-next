...
Parallelize       "Run fn-12.2 and fn-12.3 in parallel - disjoint files" (one session, batched workers), or teammates
                  each /flow-next:work a task from the same spec - atomic claims make it race-safe.
